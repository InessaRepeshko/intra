            ...
            <div className="relative mx-auto max-w-6xl">
                ...
                <div className="mb-16 max-w-2xl">
                    ...
                    <p className="mt-4 text-lg leading-relaxed text-muted-foreground text-pretty">
                        A complete toolkit for HR teams, managers, and employees
                        to run transparent and impactful 360-degree performance
                        reviews.
                    </p>
                </div>
                                ...
                                <div className="relative">
                                    <div
                                        className={`flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${
                                            isEven
                                                ? 'from-pink-100 to-yellow-100 group-hover:from-pink-200 group-hover:to-yellow-200'
                                                : 'from-yellow-100 to-pink-100 group-hover:from-yellow-200 group-hover:to-pink-200'
                                        } transition-all`}
                                    >
                                        <Icon
