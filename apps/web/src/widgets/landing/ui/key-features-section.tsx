...
const features = [
    {
        ...
        description: "Design flexible feedback forms tailored to different roles and competencies within your organization.",
    },
    {
        icon: Shield,
        title: "Complete Anonymity",
        description: "Protect respondent privacy with full anonymization settings, ensuring honest and unbiased feedback.",
    },
    {
        icon: TrendingUp,
        title: "Real-time Progress Tracking",
        description: "Monitor survey completion rates instantly and identify who's completed their feedback at a glance.",
    },
    {
        icon: BarChart3,
        title: "Visual Analytics",
        description: "Analyze feedback with interactive spider charts, bar charts, and skill comparisons for deeper insights.",
    },
]
            ...
            <div className="relative mx-auto max-w-6xl">
                ...
                <div className="mb-16 text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-muted-foreground text-pretty">
                        Everything you need to run comprehensive 360-degree feedback cycles with confidence.
                    </p>
                </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative">
                                    <div className={`mb-4 flex h-12 w-12 items-center justify-center rounded-xl ${isEven ? 'bg-gradient-to-br' : 'bg-gradient-to-tl' } from-pink-100 to-yellow-100 group-hover:from-pink-200 group-hover:to-yellow-200 transition-all`}>
