...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        "bg-muted text-foreground flex h-[calc(--spacing(5.5))] h-max w-fit max-w-full items-center justify-center gap-1 rounded-sm px-1.5 text-xs font-medium whitespace-normal break-words has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pr-0 rounded-full",
        className
      )}
      {...props}
    >
