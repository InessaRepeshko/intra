    ...
    return (
        <div className="flex flex-col flex-wrap items-start justify-start gap-1">
            <div key={user.id} className="flex items-center gap-2">
                <Avatar
                    className={`border-2 border-black/10 bg-neutral-100 rounded-full ${imageClassName}`}
                >
                    <AvatarImage
                    ...
                    />
                    <AvatarFallback
                        className={`bg-white/20 text-black text-xs font-medium`}
                    >
                ...
                <span className={`flex flex-col break-word`}>
                    <span
                        className={`font-medium whitespace-pre-wrap text-foreground ${textClassName}`}
                    >
                        {user.fullName}
                    </span>
