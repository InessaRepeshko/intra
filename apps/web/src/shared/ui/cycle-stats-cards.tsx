...
import { Award, Building2, FileText, UserRound, UsersRound, Bookmark } from 'lucide-react';
    ...
    return (
        <Card className="flex-1 min-w-[95px] w-full overflow-hidden">
            <CardHeader className="items-center pb-0">
                ...
                <CardDescription>Summary of the 360° feedback cycle scale, showing the total participation of ratees and respondents across different organizational layers.</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-row flex-wrap gap-8 w-full justify-around items-center mb-4">
                <CycleStatsCard
                    title={"Ratees"}
                    numericValue={
                        formatNumber(report.rateeCount, 0) ?? '-'
                    }
                    icon={UserRound}
                ...
                <CycleStatsCard
                    title={"Teams"}
                    numericValue={
                        formatNumber(report.teamCount, 0) ?? '-'
                    }
                    icon={Building2}
                ...
                <CycleStatsCard
                    title={"Answers"}
                    numericValue={
                        formatNumber(report.answerCount, 0) ?? '-'
                    }
                    icon={FileText}
                ...
                <CycleStatsCard
                    title={"Positions"}
                    numericValue={
                        formatNumber(report.positionCount, 0) ?? '-'
                    }
                    icon={Award}
