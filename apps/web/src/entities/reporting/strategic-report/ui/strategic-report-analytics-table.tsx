...
import { StrategicReport, StrategicReportAnalytics } from '../model/mappers';

interface StrategicReportAnalyticsTableProps {
    report: StrategicReport;
    reportAnalytics: StrategicReportAnalytics[];
}

export function StrategicReportAnalyticsTable({
    report,
    reportAnalytics,
}: StrategicReportAnalyticsTableProps) {
    ...
    sortedAnalytics.push({
        num: -1,
        id: -1,
        strategicReportId: report.id,
        competenceId: -1,
        competenceTitle: 'Average by competencies',
        averageBySelfAssessment: report.competenceGeneralAvgSelf,
        averageByTeam: report.competenceGeneralAvgTeam,
        averageByOther: report.competenceGeneralAvgOther,
        percentageBySelfAssessment: report.competenceGeneralPctSelf,
        percentageByTeam: report.competenceGeneralPctTeam,
        percentageByOther: report.competenceGeneralPctOther,
        deltaPercentageByTeam: report.competenceGeneralDeltaTeam,
        deltaPercentageByOther: report.competenceGeneralDeltaOther,
    ...
    const COLUMNS: Record<
        ...
        {
            header: (
                reportAnalytics?: StrategicReportAnalytics & { num: number },
            ) => React.ReactNode;
