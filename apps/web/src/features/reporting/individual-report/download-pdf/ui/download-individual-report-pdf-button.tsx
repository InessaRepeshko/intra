...
const DEFAULT_PRINT_WIDTH_PX = 1350;

interface DownloadIndividualReportPdfButtonProps {
    contentRef: RefObject<HTMLDivElement | null>;
    reportId: number;
    printWidth?: number | 'current';
}

export function DownloadIndividualReportPdfButton({
    contentRef,
    reportId,
    printWidth = DEFAULT_PRINT_WIDTH_PX,
}: DownloadIndividualReportPdfButtonProps) {
    ...
    const handlePrint = useReactToPrint({
        contentRef,
        documentTitle: `Individual Report #${reportId}`,
        pageStyle: `
