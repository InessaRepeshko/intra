...
function isStageDisabledFor(stage: CycleStage, mode: CycleFormMode): boolean {
    if (mode === 'create') {
        return stage !== CycleStage.NEW && stage !== CycleStage.ACTIVE;
    }
    if (mode === 'edit') {
        return (
            stage === CycleStage.PREPARING_REPORT ||
            stage === CycleStage.PUBLISHED
        );
    }
    return true;
}
                            ...
                            <Card className="border-border bg-card">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        ...
                                        for a feedback review to be valid.
                                    </CardDescription>
                                </CardHeader>
