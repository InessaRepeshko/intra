...
import { CheckCircle, ClipboardList, Clock, User } from 'lucide-react';
...
const pendingSurveys = [
    {
        ...
        type: 'peer' as const,
        subjectId: 'u2',
        subjectName: 'Michael Johnson',
        subjectRole: 'Product Manager',
        dueDate: '2026-03-15',
    },
    {
        id: 's2',
    ...
    },
    {
        ...
        subjectRole: 'Senior Software Engineer',
        dueDate: '2026-03-15',
    },
];
...
const completedSurveys = [
    {
        ...
        subjectRole: 'Frontend Developer',
    ...
    },
    {
        ...
        type: 'peer' as const,
        subjectId: 'u7',
        subjectName: 'Anna Martinez',
        subjectRole: 'Backend Developer',
                                    ...
                                    {activeTab === 'pending' ? (
                                        <>
                                            <div className="text-right">
                                                ...
                                                <p className="text-sm font-medium text-foreground">
                                                    {new Date(
                                                        (
                                                            survey as (typeof pendingSurveys)[0]
                                                        ).dueDate,
                                                    ).toLocaleDateString(
                                                        'en-US',
                                                        {
                                            ...
                                            >
                                                <Link
                                                    href={`/surveys/${survey.id}?type=${survey.type}`}
                                                >
                                        ...
                                        <div className="flex items-center gap-2 text-chart-1">
                                            ...
                                            <span className="text-sm">
                                                ...
                                                {new Date(
                                                    (
                                                        survey as (typeof completedSurveys)[0]
                                                    ).completedDate,
