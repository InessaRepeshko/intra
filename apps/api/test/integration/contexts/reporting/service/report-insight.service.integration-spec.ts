...
describe('ReportInsightService (integration)', () => {
    let module: TestingModule;
    let service: ReportInsightService;
    let insightsRepo: ReportInsightRepository;
    ...
    beforeAll(async () => {
        ...
        insightsRepo = module.get(ReportInsightRepository);
    ...
    async function seedInsights() {
        await insightsRepo.createMany(reportId, [
    ...
    describe('getByReportId', () => {
        it('returns insights tied to the report for an HR actor', async () => {
            await seedInsights();
        ...
        it('throws ForbiddenException for an unrelated actor', async () => {
            const otherId = (
