...
import { TeamDomain } from '../entities/team.domain';
import { TeamSortField } from '../value-objects/team-sort-field.enum';

export const TEAM_REPOSITORY = Symbol('ORG_STRUCTURE.TEAM_REPOSITORY');
