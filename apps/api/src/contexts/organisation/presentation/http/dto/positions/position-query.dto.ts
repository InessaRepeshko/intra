...
export class PositionQueryDto {
  @ApiPropertyOptional({ description: 'Search by title (contains, case-insensitive)', minimum: POSITION_CONSTRAINTS.TITLE.LENGTH.MIN, maximum: POSITION_CONSTRAINTS.TITLE.LENGTH.MAX, example: 'Senior Backend Engineer', type: 'string' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Search by description (contains, case-insensitive)', minimum: POSITION_CONSTRAINTS.DESCRIPTION.LENGTH.MIN, maximum: POSITION_CONSTRAINTS.DESCRIPTION.LENGTH.MAX, example: 'Backend development, architecture design, code reviews', type: 'string' })
  @IsOptional()
