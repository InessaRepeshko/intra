...
export class CreateTeamDto {
  @ApiProperty({ description: 'Team title', example: 'Engineering Team', maximum: TEAM_CONSTRAINTS.TITLE.LENGTH.MAX, minimum: TEAM_CONSTRAINTS.TITLE.LENGTH.MIN, type: 'string', required: true })
  ...
  @ApiPropertyOptional({ description: 'Team description', example: 'Responsible for product development', nullable: true, maximum: TEAM_CONSTRAINTS.DESCRIPTION.LENGTH.MAX, minimum: TEAM_CONSTRAINTS.DESCRIPTION.LENGTH.MIN, type: 'string', required: false })
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Id of team leader', example: 12, nullable: true, type: 'number', required: false })
  @IsOptional()
  @ToOptionalInt({ min: 1 })
  @IsInt()
  headId?: number | null;
