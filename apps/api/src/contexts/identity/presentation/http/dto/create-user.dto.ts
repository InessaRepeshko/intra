...
export class CreateUserDto {
  @ApiProperty({ description: `User's first name`, minimum: USER_CONSTRAINTS.NAME.LENGTH.MIN, maximum: USER_CONSTRAINTS.NAME.LENGTH.MAX, example: 'Valerii', type: 'string' })
  ...
  @ApiProperty({ description: `User's last name`, minimum: USER_CONSTRAINTS.NAME.LENGTH.MIN, maximum: USER_CONSTRAINTS.NAME.LENGTH.MAX, example: 'Velychko', type: 'string' })
  @ToOptionalTrimmedString({ min: USER_CONSTRAINTS.NAME.LENGTH.MIN, max: USER_CONSTRAINTS.NAME.LENGTH.MAX })
  @IsEnglishName(false)
  @IsString()
  @MinLength(USER_CONSTRAINTS.NAME.LENGTH.MIN)
  ...
  @ApiPropertyOptional({ description: `User's full name`, minimum: USER_CONSTRAINTS.FULL_NAME.LENGTH.MIN, maximum: USER_CONSTRAINTS.FULL_NAME.LENGTH.MAX, example: 'Valerii Velychko', type: 'string' })
  @IsOptional()
  ...
  @ApiProperty({ description: `User's email`, minimum: USER_CONSTRAINTS.EMAIL.LENGTH.MIN, maximum: USER_CONSTRAINTS.EMAIL.LENGTH.MAX, example: 'valerii.velychko@example.com', type: 'string' })
  ...
  @ApiPropertyOptional({ description: `Precomputed password hash or placeholder for external authentication`, example: '__external_auth__', maximum: USER_CONSTRAINTS.PASSWORD_HASH.LENGTH.MAX, type: 'string' })
  @IsOptional()
  @IsString()
  @MaxLength(USER_CONSTRAINTS.PASSWORD_HASH.LENGTH.MAX)
  passwordHash?: string;

  @ApiPropertyOptional({ description: `User's status`, enum: IdentityStatus, default: IdentityStatus.ACTIVE, example: IdentityStatus.ACTIVE, type: 'string' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: `Team ID`, type: 'number', example: 10, nullable: true })
  @IsOptional()
  @ToOptionalInt({ min: 1 })
  @IsInt()
  @IsPositive()
  ...
  @ApiPropertyOptional({ description: `Manager ID`, type: 'number', example: 2, nullable: true })
  @IsOptional()
  @ToOptionalInt({ min: 1 })
  @IsInt()
  @IsPositive()
