import { CYCLE_CONSTRAINTS, CycleDto, CycleStage } from '@intra/shared-kernel';
...
export class CycleResponse implements CycleDto {
    ...
    @ApiProperty({
        ...
        description: 'Minimum number of respondents',
        type: 'number',
        required: true,
    ...
    @ApiPropertyOptional({
        example: '2025-01-01T00:00:00.000Z',
        description: 'Cycle review deadline',
        type: 'string',
        format: 'date-time',
        required: false,
        nullable: true,
    ...
    @ApiPropertyOptional({
        example: '2025-01-01T00:00:00.000Z',
        description: 'Cycle approval deadline',
        type: 'string',
        format: 'date-time',
        required: false,
        nullable: true,
    ...
    @ApiPropertyOptional({
        example: '2025-01-01T00:00:00.000Z',
        description: 'Cycle response deadline',
        type: 'string',
        format: 'date-time',
        required: false,
        nullable: true,
