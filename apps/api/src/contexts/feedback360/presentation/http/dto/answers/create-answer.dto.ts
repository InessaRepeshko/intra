...
export class CreateAnswerDto {
  ...
  @ApiPropertyOptional({ example: 4, description: 'Numerical score', type: 'number', minimum: ANSWER_CONSTRAINTS.NUMERICAL_VALUE.MIN, maximum: ANSWER_CONSTRAINTS.NUMERICAL_VALUE.MAX, required: false })
  ...
  @ApiPropertyOptional({ example: 'Good progress', description: 'Text answer', type: 'string', minimum: ANSWER_CONSTRAINTS.TEXT_VALUE.LENGTH.MIN, maximum: ANSWER_CONSTRAINTS.TEXT_VALUE.LENGTH.MAX, required: false })
