...
export class ClusterScoreQueryDto {
  ...
  @ApiPropertyOptional({ example: 7, description: 'Filter by ratee ID', type: 'number' })
  @ToOptionalInt({ min: 1 })
  @IsOptional()
  @IsInt()
  rateeId?: number;

  @ApiPropertyOptional({ example: 2, description: 'Filter by review ID', type: 'number' })
  @ToOptionalInt({ min: 1 })
  @IsOptional()
  @IsInt()
  reviewId?: number;
  
  @ApiPropertyOptional({ example: 5, description: 'Filter by score', type: 'number', minimum: CLUSTER_SCORE_CONSTRAINTS.SCORE.MIN, maximum: CLUSTER_SCORE_CONSTRAINTS.SCORE.MAX })
  @ToOptionalInt({ min: CLUSTER_SCORE_CONSTRAINTS.SCORE.MIN, max: CLUSTER_SCORE_CONSTRAINTS.SCORE.MAX })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({ example: 5, description: 'Filter by answer count', type: 'number', minimum: 1 })
  @ToOptionalInt({ min: 1 })
  @IsOptional()
  @IsInt()
  @Min(1)
  ...
  @ApiPropertyOptional({ example: ClusterScoreSortField.RATEE_ID, enum: ClusterScoreSortField, description: 'Sort by field', type: 'string', default: ClusterScoreSortField.ID })
