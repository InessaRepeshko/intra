...
export class QuestionQueryDto {
    ...
    @ApiPropertyOptional({
        example: 3,
        description: 'Filter by question template id',
        type: 'number',
    })
    @ToOptionalInt({ min: 1 })
    @IsOptional()
    ...
    @ApiPropertyOptional({
        ...
        description: 'Filter by question title (contains, case-insensitive)',
        type: 'string',
    ...
    @ApiPropertyOptional({
        example: false,
        description: 'Filter by is for selfassessment',
        type: 'boolean',
    })
    @ToOptionalBool()
    @IsOptional()
    ...
    @ApiPropertyOptional({
        ...
        example: QuestionSortField.TITLE,
        description: 'Sort by field',
        default: QuestionSortField.ID,
        type: 'string',
    })
