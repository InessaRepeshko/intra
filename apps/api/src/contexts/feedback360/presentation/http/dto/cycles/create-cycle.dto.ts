...
export class CreateCycleDto {
    @ApiProperty({
        example: 'Q1 2025',
        description: 'Cycle name (contains, case-insensitive)',
        type: 'string',
    ...
    @ApiPropertyOptional({
        example: 'First 360 cycle for 2025',
    ...
    @ApiProperty({
        example: 2,
        description: 'HR responsible for the cycle',
        type: 'number',
        required: true,
    })
    @ToOptionalInt({ min: 1 })
    ...
    @ValidateIf((t) =>
        isAnonymityThresholdMet(t, CYCLE_CONSTRAINTS.ANONYMITY_THRESHOLD.MIN),
    )
