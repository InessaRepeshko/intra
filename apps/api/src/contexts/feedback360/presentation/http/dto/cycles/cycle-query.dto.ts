...
export class CycleQueryDto {
  ...
  @ApiPropertyOptional({ example: 5, default: CYCLE_CONSTRAINTS.ANONYMITY_THRESHOLD.MIN, description: 'Filter by min respondents threshold', type: 'number', minimum: CYCLE_CONSTRAINTS.ANONYMITY_THRESHOLD.MIN })
  ...
  @ApiPropertyOptional({ enum: CycleStage, example: CycleStage.ACTIVE, description: 'Filter by stage', type: 'string' })
  @ToOptionalEnum(CycleStage)
  @IsOptional()
  @IsEnum(CycleStage)
  stage?: CycleStage;

  @ApiPropertyOptional({ example: true, description: 'Filter by active', type: 'boolean' })
  @ToOptionalBool()
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;

  @ApiPropertyOptional({ description: 'Filter by start date', example: '2025-01-01T00:00:00.000Z', type: 'string', format: 'date-time' })
  @ToOptionalDate()
  @IsOptional()
  @IsDate()
  startDate?: Date;

  @ApiPropertyOptional({ description: 'Filter by end date', example: '2025-01-01T00:00:00.000Z', type: 'string', format: 'date-time' })
  @ToOptionalDate()
  @IsOptional()
  @IsDate()
  endDate?: Date;

  @ApiPropertyOptional({ description: 'Filter by review deadline', example: '2025-01-01T00:00:00.000Z', type: 'string', format: 'date-time' })
  @ToOptionalDate()
  @IsOptional()
  @IsDate()
  reviewDeadline?: Date;

  @ApiPropertyOptional({ description: 'Filter by approval deadline', example: '2025-01-01T00:00:00.000Z', type: 'string', format: 'date-time' })
  @ToOptionalDate()
  @IsOptional()
  @IsDate()
  approvalDeadline?: Date;

  @ApiPropertyOptional({ description: 'Filter by response deadline', example: '2025-01-01T00:00:00.000Z', type: 'string', format: 'date-time' })
  @ToOptionalDate()
  @IsOptional()
  @IsDate()
  responseDeadline?: Date;

  @ApiPropertyOptional({ example: CycleSortField.STAGE, enum: CycleSortField, description: 'Sort by field', default: CycleSortField.ID, type: 'string' })
