...
export class AnswerQueryDto {
    ...
    @ApiPropertyOptional({
        example: 1,
        description: 'Filter by numerical value',
        type: 'number',
    ...
    @ApiPropertyOptional({
        example: 'text',
        description: 'Filter by text value (contains, case-insensitive)',
        type: 'string',
    ...
    @ApiPropertyOptional({
        example: AnswerSortField.ANSWER_TYPE,
        enum: AnswerSortField,
        description: 'Sort by field',
        type: 'string',
        default: AnswerSortField.ID,
    })
