...
export class RespondentQueryDto {
    ...
    @ApiPropertyOptional({
        example: 1,
        description: 'Filter by respondent id',
        type: 'number',
    })
    @ToOptionalInt({ min: 1 })
    @IsOptional()
    ...
    @ApiPropertyOptional({
        ...
        description:
            'Filter by respondent full name (contains, case-insensitive)',
        type: 'string',
        minimum: RESPONDENT_CONSTRAINTS.FULL_NAME.LENGTH.MIN,
        maximum: RESPONDENT_CONSTRAINTS.FULL_NAME.LENGTH.MAX,
    })
    @ToOptionalTrimmedString({
        min: RESPONDENT_CONSTRAINTS.FULL_NAME.LENGTH.MIN,
        max: RESPONDENT_CONSTRAINTS.FULL_NAME.LENGTH.MAX,
    })
    @IsOptional()
    @IsString()
    ...
    @ApiPropertyOptional({
        ...
        description: 'Filter by respondent category',
        type: 'string',
    })
    ...
    @ApiPropertyOptional({
        example: 'Respondent note',
        description: 'Filter by respondent note (contains, case-insensitive)',
        type: 'string',
        minimum: RESPONDENT_CONSTRAINTS.RESPONDENT_NOTE.LENGTH.MIN,
        maximum: RESPONDENT_CONSTRAINTS.RESPONDENT_NOTE.LENGTH.MAX,
    })
    @ToOptionalTrimmedString({
        min: RESPONDENT_CONSTRAINTS.RESPONDENT_NOTE.LENGTH.MIN,
        max: RESPONDENT_CONSTRAINTS.RESPONDENT_NOTE.LENGTH.MAX,
    })
    @IsOptional()
    @IsString()
    ...
    @ApiPropertyOptional({
        example: 'HR note',
        description: 'Filter by HR note (contains, case-insensitive)',
        type: 'string',
        minimum: RESPONDENT_CONSTRAINTS.HR_NOTE.LENGTH.MIN,
        maximum: RESPONDENT_CONSTRAINTS.HR_NOTE.LENGTH.MAX,
    })
    @ToOptionalTrimmedString({
        min: RESPONDENT_CONSTRAINTS.HR_NOTE.LENGTH.MIN,
        max: RESPONDENT_CONSTRAINTS.HR_NOTE.LENGTH.MAX,
    })
    @IsOptional()
    @IsString()
    ...
    @ApiPropertyOptional({
        ...
        description: 'Filter by position title (contains, case-insensitive)',
        type: 'string',
        minimum: RESPONDENT_CONSTRAINTS.POSITION_TITLE.LENGTH.MIN,
        maximum: RESPONDENT_CONSTRAINTS.POSITION_TITLE.LENGTH.MAX,
    })
    @ToOptionalTrimmedString({
        min: RESPONDENT_CONSTRAINTS.POSITION_TITLE.LENGTH.MIN,
        max: RESPONDENT_CONSTRAINTS.POSITION_TITLE.LENGTH.MAX,
    })
    @IsOptional()
    @IsString()
    ...
    @ApiPropertyOptional({
        example: 'Team title',
        description: 'Filter by team title (contains, case-insensitive)',
        type: 'string',
        minimum: RESPONDENT_CONSTRAINTS.TEAM_TITLE.LENGTH.MIN,
        maximum: RESPONDENT_CONSTRAINTS.TEAM_TITLE.LENGTH.MAX,
        nullable: true,
    })
    @ToOptionalTrimmedString({
        min: RESPONDENT_CONSTRAINTS.TEAM_TITLE.LENGTH.MIN,
        max: RESPONDENT_CONSTRAINTS.TEAM_TITLE.LENGTH.MAX,
    })
    @IsOptional()
    @IsString()
    ...
    @ApiPropertyOptional({
        ...
        description: 'Filter by invited at',
        type: 'string',
        format: 'date-time',
    })
    @ToOptionalDate()
    ...
    @ApiPropertyOptional({
        example: '2025-01-20T00:00:00.000Z',
        description: 'Filter by canceled at',
        type: 'string',
        format: 'date-time',
    })
    @ToOptionalDate()
    ...
    @ApiPropertyOptional({
        example: '2025-01-20T00:00:00.000Z',
        description: 'Filter by responded at',
        type: 'string',
        format: 'date-time',
    })
    @ToOptionalDate()
    ...
    @ApiPropertyOptional({
        enum: RespondentSortField,
        example: RespondentSortField.RESPONSE_STATUS,
        description: 'Sort by field',
        default: RespondentSortField.ID,
        type: 'string',
    })
