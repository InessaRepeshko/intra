...
export class ReviewQueryDto {
    ...
    @ApiPropertyOptional({
        ...
        description: 'Ratee full name (contains, case-insensitive)',
        type: 'string',
    ...
    @ApiPropertyOptional({
        ...
        description: 'Ratee position title (contains, case-insensitive)',
        type: 'string',
    ...
    @ApiPropertyOptional({
        example: 'Anna Boyko',
        description: 'HR full name (contains, case-insensitive)',
        type: 'string',
        minimum: REVIEW_CONSTRAINTS.FULL_NAME.LENGTH.MIN,
        maximum: REVIEW_CONSTRAINTS.FULL_NAME.LENGTH.MAX,
    })
    ...
    @ApiPropertyOptional({
        ...
        description: 'HR note (contains, case-insensitive)',
        type: 'string',
    ...
    @ApiPropertyOptional({
        ...
        description: 'Team title (contains, case-insensitive)',
        type: 'string',
    ...
    @ToOptionalTrimmedString({
        min: REVIEW_CONSTRAINTS.TEAM_TITLE.LENGTH.MIN,
        max: REVIEW_CONSTRAINTS.TEAM_TITLE.LENGTH.MAX,
    })
    @IsOptional()
    @IsString()
    ...
    @ApiPropertyOptional({
        ...
        description: 'Manager full name (contains, case-insensitive)',
        type: 'string',
        minimum: REVIEW_CONSTRAINTS.FULL_NAME.LENGTH.MIN,
        maximum: REVIEW_CONSTRAINTS.FULL_NAME.LENGTH.MAX,
        nullable: true,
    ...
    @ApiPropertyOptional({
        example: 'Software Engineer',
        description: 'Manager position title (contains, case-insensitive)',
        type: 'string',
        minimum: REVIEW_CONSTRAINTS.POSITION_TITLE.LENGTH.MIN,
        maximum: REVIEW_CONSTRAINTS.POSITION_TITLE.LENGTH.MAX,
        nullable: true,
    ...
    @ApiPropertyOptional({
        example: ReviewSortField.CREATED_AT,
        enum: ReviewSortField,
        description: 'Sort by',
        default: ReviewSortField.ID,
        type: 'string',
    })
