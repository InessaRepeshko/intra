...
export class CreateQuestionDto {
  ...
  @ApiProperty({ example: 'Listens actively before responding.', description: 'Question text', type: 'string', minimum: QUESTION_CONSTRAINTS.QUESTION_TITLE.LENGTH.MIN, maximum: QUESTION_CONSTRAINTS.QUESTION_TITLE.LENGTH.MAX, required: true })
