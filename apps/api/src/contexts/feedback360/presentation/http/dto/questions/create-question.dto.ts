...
export class CreateQuestionDto {
  @ApiPropertyOptional({ example: 1, description: 'Cycle to which the question belongs', type: 'number', required: false   })
  @ToOptionalInt({ min: 1 })
  @IsOptional()
  @IsInt()
  @Min(1)
  ...
  @ApiPropertyOptional({ example: 10, description: 'Base question from library (optional)', type: 'number', required: false })
  @ToOptionalInt({ min: 1 })
  @IsOptional()
  @IsInt()
  questionTemplateId?: number;

  @ApiProperty({ example: 'Listens actively before responding.', description: 'Question text', type: 'string', minLength: QUESTION_CONSTRAINTS.QUESTION_TITLE.LENGTH.MIN, maxLength: QUESTION_CONSTRAINTS.QUESTION_TITLE.LENGTH.MAX, required: true })
  ...
  @ApiPropertyOptional({ example: 3, description: 'Competence to which the question is linked', type: 'number', required: false })
  @ToOptionalInt({ min: 1 })
  @IsOptional()
  @IsInt()
  competenceId?: number;

  @ApiPropertyOptional({ example: false, description: 'Is for selfassessment', type: 'boolean', required: false })
  @ToOptionalBool()
  @IsOptional()
  @IsBoolean()
