...
export class CreateReviewDto {
  ...
  @ApiPropertyOptional({ example: 5, description: 'Team id', type: 'number', required: false, nullable: true })
  @ToOptionalInt({ min: 1 })
  @IsOptional()
  @IsInt()
  teamId?: number | null;
  ...
  @ApiPropertyOptional({ example: 12, description: 'Ratee manager', type: 'number', required: false, nullable: true })
  @ToOptionalInt({ min: 1 })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({ example: 1, description: 'Manager position id', type: 'number', required: false, nullable: true })
  @ToOptionalInt({ min: 1 })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({ example: 1, description: 'Attached cycle', type: 'number', required: false, nullable: true })
  @ToOptionalInt({ min: 1 })
  @IsOptional()
  @IsInt()
  @Min(1)
  ...
  @ApiPropertyOptional({ example: 1, description: 'Attached report', type: 'number', required: false, nullable: true })
  @ToOptionalInt({ min: 1 })
  @IsOptional()
  @IsInt()
  @Min(1)
