...
export class CycleClusterAnalyticsController {
    ...
    @ApiResponse({
        ...
        type: CycleClusterAnalyticsResponse,
    })
    @ApiCreateAndUpdateErrorResponses()
    async upsert(
        @Body() dto: UpsertCycleClusterAnalyticsDto,
    ): Promise<CycleClusterAnalyticsResponse> {
    ...
    @ApiListReadErrorResponses()
    async search(
        @Query() query: CycleClusterAnalyticsQueryDto,
    ): Promise<CycleClusterAnalyticsResponse[]> {
    ...
    async update(
        @Param('id') id: string,
        @Body() dto: UpdateCycleClusterAnalyticsDto,
    ): Promise<CycleClusterAnalyticsResponse> {
