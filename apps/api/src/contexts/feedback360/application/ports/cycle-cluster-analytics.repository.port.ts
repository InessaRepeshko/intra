import { CycleClusterAnalyticsSearchQuery, UpdateCycleClusterAnalyticsPayload } from '@intra/shared-kernel';
...
export interface CycleClusterAnalyticsRepositoryPort {
    ...
    updateById(id: number, patch: UpdateCycleClusterAnalyticsPayload): Promise<CycleClusterAnalyticsDomain>;
